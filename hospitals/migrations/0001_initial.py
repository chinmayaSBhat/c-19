# Generated by Django 3.0.8 on 2021-05-23 17:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50)),
                ('description', models.TextField(max_length=150)),
                ('authorised_department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospitals.Department')),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
            fields=[
                ...
                ('date_of_birth', models.DateField(default=datetime.datetime(2021, 5, 23, 17, 6, 12, 970725, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observation_date', models.DateField(default=datetime.datetime(2021, 5, 23, 17, 6, 12, 971747, tzinfo=utc))),
                ('observation_for', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospitals.Test', validators=[hospitals.models.validate_department])),
                ('observing_doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospitals.Doctor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investigation_date', models.DateField(default=datetime.datetime(2021, 5, 23, 17, 6, 12, 972748, tzinfo=utc))),
                ('investigating_doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospitals.Doctor')),
